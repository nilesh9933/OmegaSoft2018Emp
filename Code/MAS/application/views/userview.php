 ...
 <div class="row text-center"> <!-- contact form outer row with centered text-->
    <h2>Registration</h2>
      <div class="col-md-10 col-md-offset-1"> 
           <form method="post" id="contact-form" class="form" name="sentMessage" novalidate action="http://localhost/MAS/index.php/user/register">
             ...
             <?php
               ...
               <div class="row">
                   <div class="col-md-6">
                       ...
                       <!-- <input type="text" autocomplete="off" class="form-control" placeholder="Your First Name *" name="fn" required>-->
                        <?php echo form_input(["autocomplete"=>"off","class"=>"form-control","placeholder"=>"Your First Name *","name"=>"firstname" ,"required"]);?>
                   ...
                   <div class="col-md-6">
                       <div class="form-group"> <!-- Your name input -->
                       <!-- <input type="text" autocomplete="off" class="form-control" placeholder="Your last Name *" name="ln" required >-->
                       <?php echo form_input(["autocomplete"=>"off","class"=>"form-control","placeholder"=>"Your Last Name *","name"=>"lastname" ,"required"]);?>
                          <p class="help-block text-danger"></p>
                          <div class="col-md-12">
                   ...
                   <div class="col-md-6">
                       <div class="form-group"> <!-- Your name input -->
                          <!--<input type="email" autocomplete="off" class="form-control" placeholder="Your email *" name="email" required>-->
                          <?php echo form_input(["autocomplete"=>"off","class"=>"form-control","placeholder"=>"Your email *","name"=>"email","required"]);?>
                          <p class="help-block text-danger"></p>
                          <div class="col-md-12">
                   ...
                   <div class="col-md-6">
                       <div class="form-group"> <!-- Your name input -->
                         <!-- <input type="text" autocomplete="off" class="form-control" placeholder="Your User Name *" name="username" required>-->
                          <?php echo form_input(["autocomplete"=>"off","class"=>"form-control","placeholder"=>"Your User Name *","name"=>"username" ,"required"]);?>
                          <p class="help-block text-danger"></p>
                          <div class="col-md-12">
                   ...
                   <div class="col-md-6">
                       <div class="form-group"> <!-- Your name input -->
                         <!-- <input type="password" autocomplete="off" class="form-control" placeholder="Your password *" name="password" required >-->
                          <?php echo form_password(["autocomplete"=>"off","class"=>"form-control","placeholder"=>"Your password *","name"=>"password" ,"required"]);?>
                          <p class="help-block text-danger"></p>
                          <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                       <div class="form-group"> <!-- Your name input -->
                          ...
                          <?php echo form_password(["autocomplete"=>"off","class"=>"form-control","placeholder"=>"Your confirm password *","name"=>"confpassword" ,"required"]);?>
                          <p class="help-block text-danger"></p>
                          <div class="col-md-12">

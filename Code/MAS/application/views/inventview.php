 ...
 <div class="row text-center"> <!-- contact form outer row with centered text-->
    <h2>Inventory</h2>
      ...
      <div class="col-md-10 col-md-offset-1"> 
           <form   method="post" id="contact-form" class="form" name="sentMessage" novalidate action="http://localhost/MAS/index.php/inventory/inventdata">
                            ...
                            <div class="col-md-4">
                                <div class="form-group"> <!-- Your name input -->
                                   <!-- <input type="text" autocomplete="off" class="form-control" placeholder="Role Name *" name="rolname" required data-validation-required-message="Please enter role name.">-->
                                     <select name="prodid" autocomplete=off class="form-control" prompt="Select Product Id" required>
                                        <option>Select Product Id</option>
                                     </select>
                                      <p class="help-block text-danger"></p>
                                      <div class="col-md-12">
                                         <?php echo form_error('prodid');?>
                                      </div>     
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group"> <!-- Your name input -->
                                   <!-- <input type="text" autocomplete="off" class="form-control" placeholder="Role Name *" name="rolname" required data-validation-required-message="Please enter role name.">-->
                                     <?php echo form_input(["autocomplete"=>"off","class"=>"form-control","placeholder"=>"Product Quantity *","name"=>"prodquantity" ,"required"]);?>
                                      <p class="help-block text-danger"></p>
                                      <div class="col-md-12">
                                         <?php echo form_error('prodquantity');?>
                                      </div>     
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group"> 
                                   <!-- <textarea class="form-control" rows="7" placeholder="Role Description" name="roldes" required data-validation-required-message="Please enter role description"></textarea>-->
                                     <?php echo form_input(["autocomplete"=>"off","class"=>"form-control","placeholder"=>"Instock *","name"=>"instock" ,"rows"=>"7","required"]);?>
                                    <p class="help-block text-danger"></p>
                                      <div class="col-md-12">
